    ...
    <>
            ...
            <div className="mt-2">
              ...
              <div className="mt-2 flex w-full items-center justify-around">
                ...
                <span
                  ...
                  className="cursor-pointer rounded-xl bg-[#38d79f] text-white"
                >
      ...
      <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
        ...
        <button
          ...
          disabled={!isValid()}
          type="button"
          className={`${!isValid() ? "bg-blue-300" : 'bg-[#526dff]'} mt-3 inline-flex w-full justify-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300  sm:mt-0 sm:w-auto`}
        >
          Aceptar
        </button>
      </div>
